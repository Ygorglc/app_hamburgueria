...
import 'package:hamburgueria/screens/cart_screen.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //cria a barra superior da pagina do item
    return Scaffold(
      appBar: AppBar(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              //vai fazer com que ocupe a maxima largura 
              ...
              children: <Widget>[
                ...
                //adiciona o valor do produto recuperado do firebase e define seus parametros
                Text(
                ...
                //define os parametros do tamanho dos itens do produto e formata para ficar dentro de quadrados
                Text(
                  "Tamanho",
                  style: TextStyle(
                    fontSize: 16.0,
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    //caso não esteja logado aparrece a opção entre para comprar, caso tenha feito o login é add ao carrinho
